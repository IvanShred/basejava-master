                            ...
                            if (!HtmlUtil.isEmpty(name)) {
                                ...
                                for (int j = 0; j < titles.length; j++) {
                                    if (!HtmlUtil.isEmpty(titles[j])) {
                                        periods.add(new PeriodActivity(DateUtil.parse(startDates[j]), DateUtil.parse(endDates[j]), titles[j], descriptions[j]));
                                    }
                                }
                        ...
                        case EDUCATION:
                            ...
                            if (orgSection != null) {
                                for (Organization org : orgSection.getOrganizations()) {
                                    List<PeriodActivity> emptyFirstPeriods = new ArrayList<>();
                                    emptyFirstPeriods.add(PeriodActivity.EMPTY);
