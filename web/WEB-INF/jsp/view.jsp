            ...
            <c:choose>
                ...
                <c:when test="${type=='EXPERIENCE' || type=='EDUCATION'}">
                    <c:forEach var="org" items="<%=((OrganizationSection) section).getOrganizations()%>">
                        ...
                        <c:forEach var="periodActivity" items="${org.periods}">
                            <jsp:useBean id="periodActivity" type="ru.javawebinar.basejava.model.PeriodActivity"/>
                            <tr>
                                <td width="15%" style="vertical-align: top"><%=HtmlUtil.formatDates(periodActivity)%>
                                </td>
                                <td><b>${periodActivity.position}</b><br>${periodActivity.description}</td>
                            </tr>
                        </c:forEach>
                    </c:forEach>
                </c:when>
